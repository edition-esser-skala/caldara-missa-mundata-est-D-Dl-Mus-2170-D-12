...
DonaViolinoI = {
  \relative c' {
    ...
    r r4 h e, h' g' h, %50
    d d, r2 r1
    r2 r4 fis g e fis cis'?
    fis h, r2 r1
    r2 r4 h a g fis h
    d^\critnote h r2 r1 %55
    r2 r4 h cis fis, h fis
    e e' r2 r1
    r2 r4 h g e fis h
    e, e' r2 r1
    r4 fis2 dis4 e h'2 d,?4 %60
    c a'2 c,4 d a'2 c,4
    h g'2 h,4 c g'2 h,4
    a fis'2 a,4 h fis' h g
    fis g8 a h4 a g h g h
    ...
    \tuplet 3/2 2 { f'4( g f) } g,2 e'2. c4
    f c g' c, a' c, fis d
    g d a' d, h' d, gis e %70
    a e h' e, c' e, h' a
    gis h e, fis8 gis a4 a, r2
    r r4 d c e a e
    f f, r2 r1
    r2 r4 e' f d e d %75
    c a, r2 r1
